...
const {createOperationsRouter}=require('./routers/operations-router');
const {createManufacturingRouter}=require('./routers/manufacturing-router');
const {createReportingRouter}=require('./routers/reporting-router');
const {createTraceabilityRouter}=require('./routers/traceability-router');
const {createLanAccessService}=require('./lan-access-service');
const {createLanRouter}=require('./routers/lan-router');
