...
const {extendRetailFiscalRouting}=require('../domains/sales-admin/retail-fiscal-routing-extension');
...
const {extendFiscalTransferInteroperability}=require('../domains/tax/fiscal-transfer-interoperability');
...
function createErpRuntime({dbPath=':memory:',now=()=>new Date().toISOString(),idFactory,fiscalRuntimeConfig=null}={}){
 ...
 const retailServices=extendRetailWithServiceProducts({...common,catalog,retail:retailBase});
 const retail=extendRetailFiscalRouting({db,retail:retailServices});
 ...
 const fiscalInteroperabilityProcurement=extendFiscalProcurementInteroperability({...common,fiscal,catalog,contacts,base:fiscalInteroperabilityBase});
 const fiscalInteroperability=extendFiscalTransferInteroperability({...common,fiscal,catalog,base:fiscalInteroperabilityProcurement});
