...
const approved={'@artisys/eventbus':'MIT','@artisys/finance-domain':'MIT','pdfjs-dist':'Apache-2.0','electron':'MIT','electron-builder':'MIT','playwright':'Apache-2.0','react':'MIT','react-dom':'MIT','vite':'MIT','typescript':'Apache-2.0','@vitejs/plugin-react':'MIT','@types/react':'MIT','@types/react-dom':'MIT'};
