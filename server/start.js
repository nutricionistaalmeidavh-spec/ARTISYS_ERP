...
const host=process.env.ERP_HOST||'0.0.0.0';const port=Number(process.env.ERP_PORT||4174);const dbPath=process.env.ERP_DB_PATH||path.join(process.cwd(),'data','artisys-erp.sqlite');
