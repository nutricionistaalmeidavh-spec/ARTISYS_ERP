...
function fixture(){let n=0;const rt=createErpRuntime({dbPath:':memory:',now:()=> '2026-09-25T12:00:00.000Z',idFactory:p=>`${p}-${++n}`});rt.finance.createAccount({id:'BANK-1',name:'Banco Principal',type:'BANK'},admin);return rt;}
