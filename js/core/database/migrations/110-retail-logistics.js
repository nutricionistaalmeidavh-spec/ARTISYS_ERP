...
CREATE TABLE IF NOT EXISTS sales_returns(id TEXT PRIMARY KEY,sale_id TEXT NOT NULL,reason TEXT NOT NULL,total_cents INTEGER NOT NULL,idempotency_key TEXT NOT NULL UNIQUE,created_by TEXT,created_at TEXT NOT NULL);
